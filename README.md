...
```
git clone https://github.com/alexandersharma/starwars-films.git
cd starwars-films
yarn
```
...
If you are suggesting a major overhaul of some aspect of this project, please submit an issue with your suggestion on `alexander.sharma@gmail.com`.
